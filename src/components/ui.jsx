...
const baseSurfaceButton =
  "inline-flex items-center justify-center text-base transition hover:opacity-50 disabled:cursor-not-allowed disabled:opacity-35 max-w-22";
...
export function PrimaryButton({ className = "", children, ...props }) {
  return (
    <button
      type="button"
      className={cx(
        "inline-flex py-2 px-2 md:px-3 items-center justify-center bg-neutral-950 text-base text-white transition hover:-translate-y-0.5 disabled:bg-transparent disabled:text-neutral-900 disabled:border disabled:border-dotted break-keep md:max-w-22 leading-4.5",
        className
      )}
      {...props}
    >
